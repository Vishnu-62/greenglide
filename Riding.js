...
export default function RunningVehiclesPage() {
  const [runningVehicles, setRunningVehicles] = useState([
    {
      id: 1,
      rider: 'John Doe',
      bikeImage: require('E:/projects/vehicle2/speedygo/vehicleimg/bike8.jpg'),
      coordinates: {
        vehicle_ID: 10001,
        latitude: 11.0614634,
    ...
    },
    {
        id: 2,
        rider: 'Alice Johnson',
        bikeImage: require('E:/projects/vehicle2/speedygo/vehicleimg/bike10.jpg'),
        coordinates: {
          vehicle_ID: 10002,
          latitude: 11.0387418,
          ...
          {isMapReady &&
            runningVehicles.map((vehicle) => (
              <Marker
                ...
                image={require('E:/projects/vehicle2/speedygo/icon3.png')} // Replace with your bike icon
